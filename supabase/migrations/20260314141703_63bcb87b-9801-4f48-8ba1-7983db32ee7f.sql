...
CREATE FUNCTION public.get_task_by_approval_token(p_token text)
 RETURNS TABLE(tarefa_id uuid, tarefa_titulo text, cliente_nome text, cliente_empresa text, approval_status text, cliente_instagram text)
 LANGUAGE plpgsql
 SECURITY DEFINER

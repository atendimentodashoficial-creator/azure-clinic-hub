        ...
        <div className={cn(
          ...
          {collapsed && onToggleCollapse ? (
            ...
            <div className="flex flex-col items-center gap-1">
              ...
              <span className="text-xs text-sidebar-foreground/60">Área do Cliente</span>
            </div>
          )}
        </div>
          ...
          {collapsed ? (
              ...
              <TooltipTrigger asChild>
                <div className="flex items-center justify-center py-2">
                  <div className="h-8 w-8 rounded-full bg-gradient-primary flex items-center justify-center text-primary-foreground text-sm font-medium cursor-default">
                    {user?.user_metadata?.full_name?.charAt(0).toUpperCase() || user?.email?.charAt(0).toUpperCase() || "C"}
                  </div>
                </div>
              </TooltipTrigger>
            ...
            <div className="flex items-center gap-3 px-3 py-2">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-xs text-sidebar-foreground/60 truncate">Cliente</p>
              </div>
            </div>
          )}
...
export const ClienteSidebar = ({ collapsed = false, onToggleCollapse }: ClienteSidebarProps) => (
  <aside className={cn(
    ...
    <ClienteSidebarContent collapsed={collapsed} onToggleCollapse={onToggleCollapse} />
  </aside>
);

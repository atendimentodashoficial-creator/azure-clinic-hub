...
function SortableHighlightItem({
  ...
  return (
    <div ref={setNodeRef} style={style} className="flex flex-col items-center gap-1.5 w-[72px]">
      ...
      {/* Delete button - outside the sortable drag area */}
      <button
        onClick={(e) => {
          e.stopPropagation();
          e.preventDefault();
        ...
        className="w-5 h-5 -mt-3 mb-1 bg-destructive rounded-full flex items-center justify-center z-10 hover:bg-destructive/80 transition-colors"
      >

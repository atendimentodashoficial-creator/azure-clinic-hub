...
import { ClienteSidebar, ClienteSidebarContent } from "@/components/layout/ClienteSidebar";
...
export default function ClienteLayout() {
  ...
  return (
    <div className="min-h-screen bg-background">
      <ClienteSidebar collapsed={collapsed} onToggleCollapse={() => setCollapsed(!collapsed)} />
        ...
        <Sheet open={open} onOpenChange={setOpen}>
          ...
          <SheetContent side="left" className="p-0 w-64 bg-sidebar border-sidebar-border flex flex-col h-full overflow-hidden">
            <div className="flex flex-col h-full overflow-hidden">
              <ClienteSidebarContent onNavigate={() => setOpen(false)} />
            </div>
          </SheetContent>
        </Sheet>
        <img 

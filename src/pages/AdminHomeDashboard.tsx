        ...
        <>
          ...
          <div className="space-y-2">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-3">
              <QuickStat icon={ListChecks} label="Ativas" value={stats.tarefasAtivas} accent="text-blue-600" onClick={() => navigate("/admin/tarefas")} />
              ...
              <QuickStat icon={Target} label="Total" value={stats.totalTarefas} accent="text-violet-600" onClick={() => navigate("/admin/tarefas")} />
            </div>
          </div>

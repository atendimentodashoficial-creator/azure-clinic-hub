...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      cobrancas: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "cobrancas_recorrencia_origem_id_fkey"
      ...
      tarefa_grid_highlights: {
        ...
        Relationships: [
          {
            foreignKeyName: "tarefa_grid_highlights_tarefa_id_fkey"
            columns: ["tarefa_id"]
            isOneToOne: false
            referencedRelation: "tarefas"
            referencedColumns: ["id"]
      ...
      tarefas: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "tarefas_produto_template_id_fkey"
            columns: ["produto_template_id"]
            isOneToOne: false
            referencedRelation: "produto_templates"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      get_grid_highlights_by_approval_token: {
        Args: { p_token: string }
        Returns: {
